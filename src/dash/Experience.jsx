  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Implemented authentication, REST APIs, and CRUD operations",
        "Improved frontend performance using React lazy loading and code splitting",
        "Worked with Redux for state management and API integration",
        "Debugged and refactored code to improve readability and maintainability"
      ],
    ...
    },
    {
      ...
      achievements: [
        "Designed REST APIs for tournaments, users, and registrations",
    ...
    },
    {
      ...
      achievements: [
        "Integrated Jikan REST API to fetch anime and character data",
        "Implemented search, filters, and pagination",
        "Optimized performance and achieved high Lighthouse scores",
        "Designed mobile-first responsive layouts"
      ],
      stack: ["React", "JavaScript", "Jikan API", "CSS"]
    }
  ];
            ...
            <div className="space-y-4">
              {experiences.map((exp, index) => (
                <div
                  ...
                  className={`group relative flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300 border ${activeId === index
                ...
                >
                  ...
                  <div className={`relative z-10 flex-shrink-0 w-4 h-4 rounded-full border-2 transition-all duration-300 ${activeId === index ? "bg-cyan-500 border-cyan-200 scale-125" : "bg-slate-800 border-slate-600 group-hover:border-cyan-500/50"
                    }`}></div>
