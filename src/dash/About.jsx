        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in-left">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-slate-400">
              <p>
                Hello! I'm <span className="text-white font-medium">Sachin Ramsamy</span>, a passionate Mern Stack Developer based in India. My journey into tech wasn't just about learning syntax; it was about the thrill of solving real-world problems through logic and design.
              </p>
              <p>
